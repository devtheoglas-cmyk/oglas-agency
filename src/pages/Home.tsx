    ...
    <section className="relative flex min-h-screen flex-col overflow-hidden bg-dark text-white">
      <div className="flex flex-1 flex-col justify-center px-4 pt-24 pb-12 sm:px-8 lg:pt-32 lg:pb-16">
        <div className={`${SHELL} text-center`}>
          <h1
            className="mx-auto max-w-[1559px] break-words font-condensed text-[clamp(2.5rem,6.13vw,98.17px)] leading-[0.85] font-semibold tracking-[-0.03em] text-center text-white uppercase [text-wrap:balance] [leading-trim:none] lg:leading-[0.8]"
            data-reveal
          >
            {heroManifesto}
          </h1>
